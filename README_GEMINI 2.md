# 🇮🇳 Indian Intellectual Property Drafting — Gemini CLI Port

> The same `indian-ip-drafting` pipeline you know, now invokable from Gemini CLI. **Same 6-agent pipeline. Same canonical agent specs. Same filing-grade output. Different LLM brain.**
...
├── skills/ (IP case-type templates)                   ← case-type templates (unchanged)
├── .gemini/                         ← NEW
│   └── commands/
...
**Forum:** Commercial Division / HC Intellectual Property Rights Division — Delhi · Madras · Calcutta · Bombay (post-IPAB-abolition under Tribunals Reforms Act 2021)

**Case types covered:** Patent infringement · Trademark infringement · Copyright infringement · Design infringement · Passing off · Geographical Indications · Trade secrets · Section 124 Trade Marks Act · Section 64 Patents Act
